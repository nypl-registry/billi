		...
		parseAboutPageData: function(data, relatedData, cb){
			...
			for (var x in data){
				...
				if (triple.predicate === 'skos:narrower'){
					if (relatedDataLookup[triple.objecturi]){
						for (var y in relatedDataLookup[triple.objecturi].hiddenLabel){
							aboutObj.narrower.push( { classmark: relatedDataLookup[triple.objecturi].hiddenLabel[y], classmarkUrlSafe: triple.objecturi.split('class:')[1],  prefLabel : (relatedDataLookup[triple.objecturi].prefLabel[y]) ? relatedDataLookup[triple.objecturi].prefLabel[y] : " ??? ERROR"  }  );
						}				
					}
				} 
				...
				if (triple.predicate === 'skos:broader'){
					if (relatedDataLookup[triple.objecturi]){
						for (var y in relatedDataLookup[triple.objecturi].hiddenLabel){
							aboutObj.broader.push( { classmark: relatedDataLookup[triple.objecturi].hiddenLabel[y], classmarkUrlSafe: triple.objecturi.split('class:')[1], prefLabel : (relatedDataLookup[triple.objecturi].prefLabel[y]) ? relatedDataLookup[triple.objecturi].prefLabel[y] : " ??? ERROR"  }  );
						}				
					}
				} 
				...
				if (triple.predicate === 'skos:relatedMatch'){
					if (relatedDataLookup[triple.objecturi]){
						for (var y in relatedDataLookup[triple.objecturi].hiddenLabel){
							aboutObj.related.push( { classmark: relatedDataLookup[triple.objecturi].hiddenLabel[y], classmarkUrlSafe: triple.objecturi.split('class:')[1], prefLabel : (relatedDataLookup[triple.objecturi].prefLabel[y]) ? relatedDataLookup[triple.objecturi].prefLabel[y] : " ??? ERROR"  }  );
						}				
					}
				} 
				...
				if (triple.predicate === 'skos:mappingRelation'){
					...
					if (triple.objecturi.search("class") > -1){
						...
						if (relatedDataLookup[triple.objecturi]){
							for (var y in relatedDataLookup[triple.objecturi].hiddenLabel){
								aboutObj.mappingLccRange.push( { classmark: relatedDataLookup[triple.objecturi].hiddenLabel[y], prefLabel : (relatedDataLookup[triple.objecturi].prefLabel[y]) ? relatedDataLookup[triple.objecturi].prefLabel[y] : " ??? ERROR"  }  );
							}				
						}else{
